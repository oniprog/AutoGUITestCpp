================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : SampleApp プロジェクトの概要
===============================================================================

この SampleApp アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。
...
SampleApp.h
    ...
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CSampleAppApp アプリケーション クラスを宣言します。

SampleApp.cpp
    これはメインのアプリケーション ソース ファイルで、CSampleAppApp アプリケーション クラスが含まれています。
...
res\SampleApp.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル SampleApp.rc にインクルードされます。
...
SampleAppDlg.h, SampleAppDlg.cpp - ダイアログ
    これらのファイルには、CSampleAppDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる SampleApp.rc に含まれています。
